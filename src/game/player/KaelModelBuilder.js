// -------------------------------------------------------------
// SHADOW ASCENSION - KAEL HUMAN CHARACTER MODEL BUILDER
// Builds a high-fidelity original humanoid fantasy hunter character
...
export function buildKaelCharacterModel() {
  ...
  // -------------------------------------------------------------
  // SHARED PBR MATERIALS (Tactical Hunter Aesthetic)
  // -------------------------------------------------------------
  // Realistic Human Skin with warm tone
  ...
  // Dark Tactical Jacket Fabric (Midnight Indigo with crisp specular contrast)
  ...
  // Leather Harness / Straps / Pouches (Rich Chestnut)
  ...
  // Dark Armor Steel (Pauldrons, buckles, toe-caps - Polished Silver Steel)
  ...
  // Glowing Cyan/Purple Runes / Inlays
  ...
  // Sword Blade Steel (Brilliant Tempered Silver)
  ...
  nodes.RightShoulder = rightShoulder;
  ...
  nodes.LeftShoulder = leftShoulder;
  ...
  nodes.CoatTailLeft = coatTailLeft;
  ...
  nodes.CoatTailRight = coatTailRight;
